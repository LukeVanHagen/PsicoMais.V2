...
<form method="post" action="{{ route('password.update') }}" class="password-update-form mt-6 space-y-6">
    ...
    <div class="form-actions flex items-center gap-4 mt-6">
        <x-primary-button class="bg-[rgb(229,231,235)] text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 px-4 py-2 rounded-md text-base">
            {{ __('Salvar') }}
        </x-primary-button>
